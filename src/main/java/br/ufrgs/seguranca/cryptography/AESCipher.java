...
public class AESCipher {
	...
	/**
	 * Encrypt a string message using AES algorithm based on the provided secret key.
	 * 
	 * @param message the message to be encrypted
	 * @param secretKey the secret key used by AES algorithm to encrypt the message
	 * 
	 * @return a {@link Hexadecimal} representation of the encrypted message
	 *  
	 * @throws Exception Thrown if any problem occur when encrypting the message
	 */
	 ...
	 * 
	 * @param encryptedMessage The hexadecimal encrypted message
	 * @param secretKey the secret key used to encrypt the message
	 * 
	 * @return The decrypted message
	 * 
	 * @throws Exception Thrown if any problem occur when decrypting the message
	 */
	public String decrypt(Hexadecimal encryptedMessage, String secretKey)
			throws Exception {
